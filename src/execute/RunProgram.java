...
public class RunProgram {
	public static void main(String args[]) throws IOException{
		...
		boolean outCustom = false;		// Set true output the image, false when output of images themselves is not necessary
		boolean outBinary = false;
	...
	public static Image importImage(String inputFilename){
		...
		try {
			...
			File inputImageFile = new File(Constants.Snippets, inputFilename);
